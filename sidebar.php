  <aside class="main-sidebar sidebar-dark-warning elevation-4" style="background-color: #332d41">
    <div class="dropdown" style="background-color: #332d41">
   	<a href="./" class="brand-link" style="background-color: #332d41">
    ...
    <div class="sidebar pb-4 mb-4" style="background-color: #332d41">
      <nav class="mt-2">
